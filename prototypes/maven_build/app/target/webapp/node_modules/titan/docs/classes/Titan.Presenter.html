...
<head>
    <meta charset="utf-8">
    <title>Titan.Presenter - Titan</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="..&#x2F;files&#x2F;src_Titan_Presenter.js.html#l1"><code>src\Titan\Presenter.js:1</code></a>
        </div>
    

    
        
            Module: <a href="../modules/Mock.html">Mock</a>
...
<div class="box intro">
    <p>Connects the Model to the View</p>
</div>


    <div class="constructor">
        <h2>Constructor</h2>
        <div id="method_Titan.Presenter" class="method item">
    <h3 class="name"><code>Titan.Presenter</code></h3>
    ...
    <div class="meta">
        ...
        <a href="..&#x2F;files&#x2F;src_Titan_Presenter.js.html#l1"><code>src\Titan\Presenter.js:1</code></a>
            ...
            <ul class="params-list">
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>An option JavaScript object containing the EventBus and View</p>
                    </div>
...
<div id="classdocs" class="tabview">
    ...
    <h3 class="name"><code>_configure</code></h3>
    ...
    <div class="meta">
        ...
        <a href="..&#x2F;files&#x2F;src_Titan_Presenter.js.html#l43"><code>src\Titan\Presenter.js:43</code></a>
    ...
    <div class="description">
        <p>Allows options to be specified both at instantiation and when extending.
Merges both options and checks for special options in presenterOptions, and applies them directly to the
Presenter object, then sets the merged options to this.options</p>
    </div>
    ...
    <div class="meta">
        ...
        <a href="..&#x2F;files&#x2F;src_Titan_Presenter.js.html#l19"><code>src\Titan\Presenter.js:19</code></a>
    ...
    <div class="description">
        <p>Method called when Presenter is initialised. Empty by default, it can be overridden to provide functionality</p>
    </div>
    ...
    <div class="meta">
        ...
        <a href="..&#x2F;files&#x2F;src_Titan_Presenter.js.html#l28"><code>src\Titan\Presenter.js:28</code></a>
    ...
    <div class="description">
        <p>Replaces the contents of the specified container with the current widget</p>
    </div>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                ...
                <li class="param">
                        ...
                        <span class="type"><a href="..\classes\Titan.Element.html" class="crosslink">Titan.Element</a></span>
                    

                    

                    <div class="param-description">
                        <p>The Element to place the widget within</p>
                    </div>

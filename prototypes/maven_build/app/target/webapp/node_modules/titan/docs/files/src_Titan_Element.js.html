...
<head>
    <meta charset="utf-8">
    <title>src\Titan\Element.js - Titan</title>
    ...
    <div id="api-tabview" class="tabview">
        ...
        <label for="api-show-deprecated">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
                        <h1 class="file-heading">File: src\Titan\Element.js</h1>
 ...
 *
 * @class Titan.Element
 * @param selector {String} The CSS selector for the element(s) to be used as container(s)
 * @constructor
 *&#x2F;
Titan.Element = function (selector) {
    this.$el = $(selector);
};

_.extend(Titan.Element.prototype, {
    ...
    addWidget: function (widget) {
        this.$el.append(widget.getElement());
    },

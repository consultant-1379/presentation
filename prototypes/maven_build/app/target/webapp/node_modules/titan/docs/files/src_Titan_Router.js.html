...
<head>
    <meta charset="utf-8">
    <title>src\Titan\Router.js - Titan</title>
    ...
    <div id="api-tabview" class="tabview">
        ...
        <label for="api-show-deprecated">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
                        <h1 class="file-heading">File: src\Titan\Router.js</h1>
...
var Router = Titan.Router = function (options) {
    if (!options) throw new Error(&#x27;Cannot create Router without options&#x27;);
    if (!options.eventBus) throw new Error(&#x27;Cannot create Router without eventBus&#x27;);
    if (!options.places) throw new Error(&#x27;Cannot create Router without places&#x27;);
    this.defaultPlaces = [];
...
_.extend(Router.prototype, {
    ...
    init: function (places) {
        ...
        _.each(places, function (Place) {
            ...
            if (!this.silent &amp;&amp; Place.prototype.default) {

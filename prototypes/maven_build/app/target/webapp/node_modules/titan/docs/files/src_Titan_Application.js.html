...
<head>
    <meta charset="utf-8">
    <title>src\Titan\Application.js - Titan</title>
    ...
    <div id="api-tabview" class="tabview">
        ...
        <label for="api-show-deprecated">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
                        <h1 class="file-heading">File: src\Titan\Application.js</h1>
...
var Application = Titan.Application = function (options) {
    ...
    this.eventBus = options.eventBus ? options.eventBus : new Titan.EventBus();
    if (options.container instanceof Titan.Element) {
        this.container = options.container;
    } else {
        this.container = new Titan.Element(options.container || &#x27;body&#x27;);
    }
};

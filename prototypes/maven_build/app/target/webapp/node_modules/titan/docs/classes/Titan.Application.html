...
<head>
    <meta charset="utf-8">
    <title>Titan.Application - Titan</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="..&#x2F;files&#x2F;src_Titan_Application.js.html#l1"><code>src\Titan\Application.js:1</code></a>
        </div>
...
<div class="box intro">
    <p>Encapsulates the entire Application. Eliminates the need to manually create an Element, Router and
MainController, and begin tracking of the hash value on the router. Triggers the initialisation of the whole app.</p>
</div>


    <div class="constructor">
        <h2>Constructor</h2>
        <div id="method_Titan.Application" class="method item">
    <h3 class="name"><code>Titan.Application</code></h3>
    ...
    <div class="meta">
        ...
        <a href="..&#x2F;files&#x2F;src_Titan_Application.js.html#l1"><code>src\Titan\Application.js:1</code></a>
...
<div id="classdocs" class="tabview">
    ...
    <div class="meta">
        ...
        <a href="..&#x2F;files&#x2F;src_Titan_Application.js.html#l24"><code>src\Titan\Application.js:24</code></a>
    ...
    <div class="description">
        <p>Creates a new Router and MainController with the EventBus, places and container for the application, and
begins tracking changes to the route.</p>
    </div>
